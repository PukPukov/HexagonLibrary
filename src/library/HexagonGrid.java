...
public class HexagonGrid {
    ...
    public HexagonGrid(Orientation orientation, Point origin, Point size, Morton64 mort) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!HexagonGrid.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        HexagonGrid other = (HexagonGrid)obj;
