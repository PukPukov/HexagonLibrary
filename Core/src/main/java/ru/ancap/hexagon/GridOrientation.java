...
public final class GridOrientation {
    ...
    public GridOrientation(GridOrientation gridOrientation) {
        this(gridOrientation.name, gridOrientation.f, gridOrientation.b, gridOrientation.startAngle, gridOrientation.modifiers, gridOrientation.sinuses, gridOrientation.cosinuses);
    }
